        ...
        <footer class="bloc_footer">
			...
			<section class="footer_section">
				<div class="footer_section_div">
					<a title="designo Home page" href="index.html"><img class="footer_img_logo" alt="logo Designo" src="<?php echo get_template_directory_uri(); ?>/src/img/logo_footer.png" /></a>
