...
<html lang="en">
	...
	<body>
		...
		<header class="bloc_header">
			<a title="designo Home page" href="<?php echo get_site_url(); ?>"><img class="header_img_logo" src="<?php echo get_template_directory_uri(); ?>/src/img/logo_header.png" alt="logo designo" /></a>
